...
COWORK_PUBLISH_PROMPT = (
    ...
    "- NEVER invent a password. If the user wants a password but didn't state it, point them to\n"
    "  the publish panel (Access → Password) — never ask for the password in chat.\n"
