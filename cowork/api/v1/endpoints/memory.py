...
# Keep the PUT for any direct API consumers
@router.put("/", response_model=MemoryResponse)
async def update_memory_canonical(body: dict, session: SessionDep):
    from cowork.schemas.memory import MemoryUpdateRequest
