...
# Static subpaths (/edits/*, /shares/accept) live alongside the dynamic
# /{artifact_id}/* routes above; they don't collide because the literal
# second segment (edits/shares/accept) differs from versions/checkpoints/etc.
api_router.include_router(artifact_edits.router, prefix="/artifacts", tags=["artifact-edits"])
api_router.include_router(artifact_shares.router, prefix="/artifacts", tags=["artifact-shares"])
